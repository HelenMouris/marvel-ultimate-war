...
public class Stone2 extends CustomButton {
	private JLabel a1;
	private CurrentChampionPanel currentPanel;
	private Game game;

	public Stone2(JLabel a1, CurrentChampionPanel currentPanel, Game game) {
		this.a1 = a1;
