...
public class Stone1 extends CustomButton {
	private JLabel a1;
	private CurrentChampionPanel currentPanel;
	private Game game;

	public Stone1(JLabel a1, CurrentChampionPanel currentPanel, Game game) {
		this.a1 = a1;
